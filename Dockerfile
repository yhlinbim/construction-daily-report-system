...
COPY CDRS.UnitTests/CDRS.UnitTests.csproj CDRS.UnitTests/
...
# Run unit tests ¡X build fails if any test fails
RUN dotnet test CDRS.UnitTests/CDRS.UnitTests.csproj \
...
# =============================================
# Stage 2: Runtime
# ASP.NET runtime image ¡X no SDK, no build tools
